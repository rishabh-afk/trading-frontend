export const strings: { [key: string]: string } = {
  ...
  // TRading Messages
  SELL_OFF:
    "Sell Off Signal: The current price is experiencing a significant decline, indicating potential downward momentum. Traders may consider reducing positions or taking precautionary measures.",
  CALL_BUY:
    "Buy Call Signal: The current price has crossed above the Top Center (TC) line, indicating a potential upward trend.",
  MONITORING:
    "Monitoring Signal: The current price is positioned between the Bottom Center (BC) and Top Center (TC) lines, suggesting a period of stability. No immediate action is required.",
  PUT_BUY:
    "Buy Put Signal: The current price is below the Bottom Center (BC) line, indicating a potential downward trend.",
};
